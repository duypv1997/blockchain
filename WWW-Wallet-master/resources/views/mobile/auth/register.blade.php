...
<div class="container">
  <div class="row">
    <div class="header_icon">
      <img src="{{ asset('/images/coin_icon.png') }}" class="icon-register">
      <span class="biko-register">WWW<br><span class="biko-register-subname">coin wallet</span></span>
    </div>
    <p class="title-signup">SIGNUP</p>
  </div>
    ...
    <register>
      <template scope="getCode">
        <form method="POST" action="{{ route('register') }}">
          ...
          <div class="form-group borderBottom">
            <label for="password-confirm" class="label password">{{ __('CONFIRM PASSWORD') }}</label>
