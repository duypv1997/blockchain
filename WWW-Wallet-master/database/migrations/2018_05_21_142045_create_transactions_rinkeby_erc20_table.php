...
class CreateTransactionsRinkebyErc20Table extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('transactions_rinkeby_erc20', function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists('transactions_rinkeby_erc20');
    }
}
