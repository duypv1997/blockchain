...
class CreateTransactionsRinkebyEthTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('transactions_rinkeby_eth', function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists('transactions_rinkeby_eth');
    }
}
