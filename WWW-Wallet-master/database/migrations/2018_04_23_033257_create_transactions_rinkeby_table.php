...
class CreateTransactionsRinkebyTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('transactions_rinkeby', function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists('transactions_rinkeby');
    }
}
